...
def generate_audio(text, voice_id):
    ...
    json_file1 = os.path.join(json_dir, "compsci_news_podcast.json")
    json_file2 = os.path.join(json_dir, "compsci_news_podcast_part2.json")
...
def main():
    ...
    try:
        ...
        print(f"Error: {e}")
        print("Please run create_compsci_news_podcast.py and create_compsci_news_podcast_part2.py first")
        return
    
    # Check if final output already exists
    output_file = os.path.join(output_folder, "compsci-news-episode1.mp3")
    ...
    part1_file = os.path.join(output_folder, "compsci-news-part1.mp3")
    if os.path.exists(part1_file):
        ...
        audio_part1 = process_podcast_part(podcast_part1, output_folder, "compsci_part1")
    ...
    part2_file = os.path.join(output_folder, "compsci-news-part2.mp3")
    if os.path.exists(part2_file):
        ...
        audio_part2 = process_podcast_part(podcast_part2, output_folder, "compsci_part2")
    ...
    try:
        ...
        try:
            ...
            temp_combined = os.path.join(output_folder, "compsci-news-combined-temp.mp3")
