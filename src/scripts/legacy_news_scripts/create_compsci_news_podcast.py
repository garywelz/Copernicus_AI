...
podcast = {
    ...
    "segments": [
        ...
        {
            "speaker": {"name": "Mira", "voice_id": "XB0fDUnXU5powFXDhCwa"},  # Charlotte
...
json_file = os.path.join(json_dir, "compsci_news_podcast.json")
with open(json_file, 'w') as f:
    json.dump(podcast, f, indent=2)

print(f"Created {json_file} with the first part of the Compsci News podcast") 