...
def main():
    ...
    json_file1 = os.path.join(json_dir, "math_news_podcast.json")
    json_file2 = os.path.join(json_dir, "math_news_podcast_part2.json")
    ...
    try:
        ...
        print(f"Error: {e}")
        print("Please run create_math_news_podcast.py and create_math_news_podcast_part2.py first")
        return
    ...
    output_file = os.path.join(output_folder, "math-news-episode1.wav")
